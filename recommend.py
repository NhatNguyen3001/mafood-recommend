...
def getGeoCoord(geo_address, API_KEY):
    ...
    if data['status'] == 'OK':
        ...
        st.title("Please search for the address on Google Map")
...
if search:
    ...
    if len(final_index_keep) > 0:
        ...
        st.write("You should eat at:")
        st.write("Name: ", final_name)
        st.write("Address: ", final_address)
        st.write("District: ",final_district)
        st.write("Rating: ", final_rating)
